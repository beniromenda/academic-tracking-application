...
SECRET_KEY = 'django-insecure-3^kwvttxo_)*7*!!4vpc(4)b5%)=+9om*nniz=a)rtu4bjo8te'
...
MIDDLEWARE = [
    ...
    'core.middleware.DisableClientSideCacheMiddleware',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'core.context_processors.subject_context',
            ],
        },
    },
]
